...
```{r}
 m_mean_temp      <- glm.nb(active_nests ~ mean_temp,      data = effort_weather)
m_max_temp       <- glm.nb(active_nests ~ max_temp,       data = effort_weather)
m_min_temp       <- glm.nb(active_nests ~ min_temp,       data = effort_weather)

m_total_rain     <- glm.nb(active_nests ~ total_rain,     data = effort_weather)
m_rain_days      <- glm.nb(active_nests ~ rain_days,      data = effort_weather)
m_max_rain       <- glm.nb(active_nests ~ max_rain,       data = effort_weather)

m_lag_total_rain <- glm.nb(active_nests ~ lag_total_rain, data = effort_weather)

m_mean_wind      <- glm.nb(active_nests ~ mean_wind,      data = effort_weather)
m_max_wind       <- glm.nb(active_nests ~ max_wind,       data = effort_weather)

m_hail_days      <- glm.nb(active_nests ~ hail_days,      data = effort_weather)
...
```{r}
m_cold_wet_amt   <- glm.nb(active_nests ~ min_temp + total_rain, data = effort_weather)
m_cold_storm    <- glm.nb(active_nests ~ min_temp + max_rain,   data = effort_weather)
m_cold_wind     <- glm.nb(active_nests ~ min_temp + max_wind,   data = effort_weather)

m_hail_wind     <- glm.nb(active_nests ~ hail_days + max_wind,  data = effort_weather)
m_hail_rain     <- glm.nb(active_nests ~ total_rain + hail_days,     data = effort_weather)
m_rain_wind     <- glm.nb(active_nests ~ max_rain + max_wind,   data = effort_weather)

m_heat_wet_days <- glm.nb(active_nests ~ max_temp + rain_days,  data = effort_weather)
...
```{r}
m_int_cold_wet  <- glm.nb(active_nests ~ min_temp * rain_days,     data = effort_weather)
m_int_rain_hail <- glm.nb(active_nests ~ total_rain * hail_days,     data = effort_weather)
m_int_cold_wind <- glm.nb(active_nests ~ min_temp * mean_wind,     data = effort_weather)
m_int_lag_heat  <- glm.nb(active_nests ~ lag_total_rain * max_temp,data = effort_weather)
...
```{r}
top_models_effort <- cand_effort[c(
  "hail_days",
  "max_temp",
  "hail_maxW",
  "total_rain",
...
```{r}
dev_expl <- function(m) 1 - (deviance(m) / m$null.deviance)

sapply(top_models_effort, dev_expl)
