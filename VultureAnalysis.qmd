...
# ---- short labels (edit these if you want even shorter) ----
...
```
Grey nodes represent latent biological states, blue indicates observed weather, dark grey indicates temporal indexing, and T* denotes the observed timing variable subject to missingness.
