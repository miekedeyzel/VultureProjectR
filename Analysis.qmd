  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        % Make entire table captions (legends) bold
        \usepackage{caption}
        \captionsetup[table]{
          labelfont=bf,
          textfont=bf,
...
![](A1.png) Figure A1: The temporal trends of the weather variables included in the analysis. Data is derived from the Kimberley meteorological station (1993 - 2024). Annual values are represented by the grey lines with the green lines representing the fitted linear trend.

![](Corr.png) Figure A2: A correlation matrix showing the persons correlation coefficients between all weather variables included in the analyses on the effects of weather on the breeding ecology of African white-backed vultures at Dronfield (1993-2025).  
...
```{r fig.cap="The number of active nests at Dronfield (1993–2024)."}
...
```{r fig.cap="Histogram showing the distribution of annual breeding success proportions at Dronfield (1993–2024)."}
...
```{r fig.cap="The proportion of failed nests vs successfull nests at Dronfield (1993-2024)"}
...
### Number of active nests over time

```{r fig.cap="The number of active nests at Dronfield, over time (1993-2024)"}
...
objective3_table <- tribble(
  ...
  # ---- Baseline ----
  "**Baseline**", "",
  "Baseline (null / intercept-only) model for breeding timing (laying date, day of year).",
  "lay_DOY ~ 1",

  # ---- Temperature (March cues) ----
  "**Temperature**", "",
  "Warmer conditions in March may act as a cue for the initiation of breeding, advancing laying dates.",
  "lay_DOY ~ meanT",

  "Colder March conditions may delay breeding due to increased energetic costs and reduced adult condition.",
  "lay_DOY ~ minT",

  # ---- Rain (March cues) ----
  "**Rain**", "",
  "Prolonged wet conditions in March may delay breeding by limiting foraging efficiency.",
  "lay_DOY ~ rainD",

  "Higher March rainfall may signal improved food availability and advance breeding timing.",
  "lay_DOY ~ totR",

  # ---- Wind (March cues) ----
  "**Wind**", "",
  "Persistent windy conditions in March increase flight costs and may delay breeding timing.",
  "lay_DOY ~ wind",

  # ---- Lagged effects (previous year) ----
  "**Lagged effects**", "",
  "Thermal conditions in the previous year may influence physiological state entering the breeding season and affect laying timing.",
  "lay_DOY ~ lagMeanT",

  "Higher rainfall in the previous year may improve food availability and adult condition entering the breeding season, allowing earlier laying.",
  "lay_DOY ~ lagTotR",
  ...
  # ---- Joint effects ----
  "**Joint effects**", "",
  "March cues and previous-year rainfall may jointly influence breeding timing.",
  "lay_DOY ~ cue_plus_lagR",

  "Previous-year rainfall and March rainy days may jointly influence breeding timing.",
  "lay_DOY ~ lagR_plus_cueRain",

  # ---- Interactions ----
  "**Interactions**", "",
  "The effect of March temperature cues on laying timing may depend on March rainfall conditions.",
  "lay_DOY ~ int_TR",

  "Carry-over effects from the previous year may modify responses to March temperature cues.",
  "lay_DOY ~ lagR_x_meanT"
)

kable(
  objective3_table,
  align = c("l", "l"),
  caption = "Objective 3 candidate model set for breeding timing (laying date, day of year). March weather cues and lagged (previous-year) effects."
)
```

### Timing data used 

```{r fig.cap="Variation in breeding timing (laying date) across the study period in Dronfield (1993-2024)." }
...
```{r fig.cap="The relationship between the total annual rainfall in the previous year and breeding timing (median laying date)"}
